...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_af8bbc065bfe912956f09fed6e470dab {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_af8bbc065bfe912956f09fed6e470dab() {
        ...
        ~__struct_compiled_op_af8bbc065bfe912956f09fed6e470dab(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_af8bbc065bfe912956f09fed6e470dab_executor(__struct_compiled_op_af8bbc065bfe912956f09fed6e470dab* self) {
            return self->run();
        }

        static void __struct_compiled_op_af8bbc065bfe912956f09fed6e470dab_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_af8bbc065bfe912956f09fed6e470dab*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_af8bbc065bfe912956f09fed6e470dab* struct_ptr = new __struct_compiled_op_af8bbc065bfe912956f09fed6e470dab();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_af8bbc065bfe912956f09fed6e470dab_executor), struct_ptr, __struct_compiled_op_af8bbc065bfe912956f09fed6e470dab_destructor);
  return thunk; }
...
PyMODINIT_FUNC initaf8bbc065bfe912956f09fed6e470dab(void){
   import_array();
   (void) Py_InitModule("af8bbc065bfe912956f09fed6e470dab", MyMethods);
}
