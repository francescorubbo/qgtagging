...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_31354728752633bd8e6bcf0655f5ee04 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_31354728752633bd8e6bcf0655f5ee04() {
        ...
        ~__struct_compiled_op_31354728752633bd8e6bcf0655f5ee04(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_31354728752633bd8e6bcf0655f5ee04_executor(__struct_compiled_op_31354728752633bd8e6bcf0655f5ee04* self) {
            return self->run();
        }

        static void __struct_compiled_op_31354728752633bd8e6bcf0655f5ee04_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_31354728752633bd8e6bcf0655f5ee04*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_31354728752633bd8e6bcf0655f5ee04* struct_ptr = new __struct_compiled_op_31354728752633bd8e6bcf0655f5ee04();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_31354728752633bd8e6bcf0655f5ee04_executor), struct_ptr, __struct_compiled_op_31354728752633bd8e6bcf0655f5ee04_destructor);
  return thunk; }
...
PyMODINIT_FUNC init31354728752633bd8e6bcf0655f5ee04(void){
   import_array();
   (void) Py_InitModule("31354728752633bd8e6bcf0655f5ee04", MyMethods);
}
