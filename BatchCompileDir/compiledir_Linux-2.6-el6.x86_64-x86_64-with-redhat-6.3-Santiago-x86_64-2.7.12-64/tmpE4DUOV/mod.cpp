...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b() {
        ...
        ~__struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b_executor(__struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b* self) {
            return self->run();
        }

        static void __struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b* struct_ptr = new __struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b_executor), struct_ptr, __struct_compiled_op_12a7b9c536a3dbb6aa746d161896131b_destructor);
  return thunk; }
...
PyMODINIT_FUNC init12a7b9c536a3dbb6aa746d161896131b(void){
   import_array();
   (void) Py_InitModule("12a7b9c536a3dbb6aa746d161896131b", MyMethods);
}
