...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b() {
        ...
        ~__struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b(void) {
            cleanup();
        }
...
npy_int64& V1_i = *V1_iter;
                  ...
                  {
npy_int64 V19_tmp1;
V19_tmp1 = V3_i * V13_i * V15_i * V17_i;
npy_int64 V19_tmp2;
V19_tmp2 = V7_i * V9_i * V11_i;
npy_int8 V19_tmp3;
V19_tmp3 = (V3_i == V5_i);
npy_int64 V19_tmp4;
V19_tmp4 = -V19_tmp1;
...
if (V19_tmp2 < 0) {
    if (V19_tmp4 < 0) {
        V19_tmp5 = ((-V19_tmp2) / (-V19_tmp4));
    } else {
        V19_tmp5 = - ((-V19_tmp2) / V19_tmp4) - ((THEANO_MACRO_MOD((-V19_tmp2), V19_tmp4) == 0) ? 0 : 1);
    }
} else {
    if (V19_tmp4 < 0) {
        V19_tmp5 = - (V19_tmp2 / (-V19_tmp4)) - ((THEANO_MACRO_MOD(V19_tmp2, (-V19_tmp4)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b_executor(__struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b* self) {
            return self->run();
        }

        static void __struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b* struct_ptr = new __struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b_executor), struct_ptr, __struct_compiled_op_e9e91a658c4f06c3f6406db7006c8e4b_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite9e91a658c4f06c3f6406db7006c8e4b(void){
   import_array();
   (void) Py_InitModule("e9e91a658c4f06c3f6406db7006c8e4b", MyMethods);
}
