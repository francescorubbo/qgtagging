...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_754460a76e96baf2fbdefd138a212350 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_754460a76e96baf2fbdefd138a212350() {
        ...
        ~__struct_compiled_op_754460a76e96baf2fbdefd138a212350(void) {
            cleanup();
        }
...
// Op class MakeVector
        ...
        if(!V1 || PyArray_DIMS(V1)[0] != 4){
            ...
            *((npy_int64 *)PyArray_GETPTR1(V1, 3)) = *((npy_int64 *) PyArray_DATA(V3));
            __label_5:
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_754460a76e96baf2fbdefd138a212350_executor(__struct_compiled_op_754460a76e96baf2fbdefd138a212350* self) {
            return self->run();
        }

        static void __struct_compiled_op_754460a76e96baf2fbdefd138a212350_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_754460a76e96baf2fbdefd138a212350*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_754460a76e96baf2fbdefd138a212350* struct_ptr = new __struct_compiled_op_754460a76e96baf2fbdefd138a212350();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_754460a76e96baf2fbdefd138a212350_executor), struct_ptr, __struct_compiled_op_754460a76e96baf2fbdefd138a212350_destructor);
  return thunk; }
...
PyMODINIT_FUNC init754460a76e96baf2fbdefd138a212350(void){
   import_array();
   (void) Py_InitModule("754460a76e96baf2fbdefd138a212350", MyMethods);
}
