...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73() {
        ...
        ~__struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73(void) {
            cleanup();
        }
...
V19_tmp1 = V7_i + V9_i;
npy_int64 V19_tmp2;
V19_tmp2 = V13_i - V15_i;
npy_int8 V19_tmp3;
V19_tmp3 = (V11_i > V5_i);
npy_int64 V19_tmp4;
V19_tmp4 = ((V17_i)<(V19_tmp1)? (V17_i): ((V19_tmp1)<=(V17_i)? (V19_tmp1): nan("")));
npy_int8 V19_tmp5;
V19_tmp5 = (V19_tmp1 < V5_i);
npy_int8 V19_tmp6;
V19_tmp6 = (V19_tmp5 & V19_tmp3);
npy_int64 V19_tmp7;
V19_tmp7 = V19_tmp6 ? V19_tmp2 : V19_tmp4;
V1_i = V3_i ? V5_i : V19_tmp7;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73_executor(__struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73* self) {
            return self->run();
        }

        static void __struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73* struct_ptr = new __struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73_executor), struct_ptr, __struct_compiled_op_90bb2e74d66cf49e01e8d06581974d73_destructor);
  return thunk; }
...
PyMODINIT_FUNC init90bb2e74d66cf49e01e8d06581974d73(void){
   import_array();
   (void) Py_InitModule("90bb2e74d66cf49e01e8d06581974d73", MyMethods);
}
