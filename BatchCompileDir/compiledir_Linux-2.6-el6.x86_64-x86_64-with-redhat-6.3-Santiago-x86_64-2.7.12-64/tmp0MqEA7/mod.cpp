...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_cb7f8351753f849a975c264d7aaeef18 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_cb7f8351753f849a975c264d7aaeef18() {
        ...
        ~__struct_compiled_op_cb7f8351753f849a975c264d7aaeef18(void) {
            cleanup();
        }
...
// Op class Alloc
            ...
            {
                Py_XDECREF(V1);
                V1 = (PyArrayObject*) PyArray_SimpleNew(0,
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_cb7f8351753f849a975c264d7aaeef18_executor(__struct_compiled_op_cb7f8351753f849a975c264d7aaeef18* self) {
            return self->run();
        }

        static void __struct_compiled_op_cb7f8351753f849a975c264d7aaeef18_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_cb7f8351753f849a975c264d7aaeef18*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_cb7f8351753f849a975c264d7aaeef18* struct_ptr = new __struct_compiled_op_cb7f8351753f849a975c264d7aaeef18();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_cb7f8351753f849a975c264d7aaeef18_executor), struct_ptr, __struct_compiled_op_cb7f8351753f849a975c264d7aaeef18_destructor);
  return thunk; }
...
PyMODINIT_FUNC initcb7f8351753f849a975c264d7aaeef18(void){
   import_array();
   (void) Py_InitModule("cb7f8351753f849a975c264d7aaeef18", MyMethods);
}
