...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_7246562425f01958b2baa03664f9e6dc {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7246562425f01958b2baa03664f9e6dc() {
        ...
        ~__struct_compiled_op_7246562425f01958b2baa03664f9e6dc(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7246562425f01958b2baa03664f9e6dc_executor(__struct_compiled_op_7246562425f01958b2baa03664f9e6dc* self) {
            return self->run();
        }

        static void __struct_compiled_op_7246562425f01958b2baa03664f9e6dc_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7246562425f01958b2baa03664f9e6dc*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7246562425f01958b2baa03664f9e6dc* struct_ptr = new __struct_compiled_op_7246562425f01958b2baa03664f9e6dc();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7246562425f01958b2baa03664f9e6dc_executor), struct_ptr, __struct_compiled_op_7246562425f01958b2baa03664f9e6dc_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7246562425f01958b2baa03664f9e6dc(void){
   import_array();
   (void) Py_InitModule("7246562425f01958b2baa03664f9e6dc", MyMethods);
}
