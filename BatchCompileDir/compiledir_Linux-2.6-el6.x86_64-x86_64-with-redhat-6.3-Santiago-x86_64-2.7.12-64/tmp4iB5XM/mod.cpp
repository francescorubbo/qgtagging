...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b5b907a7251fe21375a27325490c6f1c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b5b907a7251fe21375a27325490c6f1c() {
        ...
        ~__struct_compiled_op_b5b907a7251fe21375a27325490c6f1c(void) {
            cleanup();
        }
...
dims[1] = V5_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V9));
        }
        else {
...
V11_tmp1 = V3_i ? V9_i : V7_i;
npy_float32 V11_tmp2;
V11_tmp2 = V3_i ? V5_i : V7_i;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b5b907a7251fe21375a27325490c6f1c_executor(__struct_compiled_op_b5b907a7251fe21375a27325490c6f1c* self) {
            return self->run();
        }

        static void __struct_compiled_op_b5b907a7251fe21375a27325490c6f1c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b5b907a7251fe21375a27325490c6f1c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b5b907a7251fe21375a27325490c6f1c* struct_ptr = new __struct_compiled_op_b5b907a7251fe21375a27325490c6f1c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b5b907a7251fe21375a27325490c6f1c_executor), struct_ptr, __struct_compiled_op_b5b907a7251fe21375a27325490c6f1c_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb5b907a7251fe21375a27325490c6f1c(void){
   import_array();
   (void) Py_InitModule("b5b907a7251fe21375a27325490c6f1c", MyMethods);
}
