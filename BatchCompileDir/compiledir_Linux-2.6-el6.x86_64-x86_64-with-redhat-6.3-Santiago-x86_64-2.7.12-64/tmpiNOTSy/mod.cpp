...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32() {
        ...
        ~__struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32_executor(__struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32* self) {
            return self->run();
        }

        static void __struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32* struct_ptr = new __struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32_executor), struct_ptr, __struct_compiled_op_32c5ce134e2d3b96601faf00ec098d32_destructor);
  return thunk; }
...
PyMODINIT_FUNC init32c5ce134e2d3b96601faf00ec098d32(void){
   import_array();
   (void) Py_InitModule("32c5ce134e2d3b96601faf00ec098d32", MyMethods);
}
