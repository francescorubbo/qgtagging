...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_b9146d6473958f470333f111202064ce {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b9146d6473958f470333f111202064ce() {
        ...
        ~__struct_compiled_op_b9146d6473958f470333f111202064ce(void) {
            cleanup();
        }
...
if (V13_tmp1 < 0) {
    if (V11_i < 0) {
        ...
        V1_i = - ((-V13_tmp1) / V11_i) - ((THEANO_MACRO_MOD((-V13_tmp1), V11_i) == 0) ? 0 : 1);
    }
} else {
    if (V11_i < 0) {
        V1_i = - (V13_tmp1 / (-V11_i)) - ((THEANO_MACRO_MOD(V13_tmp1, (-V11_i)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b9146d6473958f470333f111202064ce_executor(__struct_compiled_op_b9146d6473958f470333f111202064ce* self) {
            return self->run();
        }

        static void __struct_compiled_op_b9146d6473958f470333f111202064ce_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b9146d6473958f470333f111202064ce*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b9146d6473958f470333f111202064ce* struct_ptr = new __struct_compiled_op_b9146d6473958f470333f111202064ce();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b9146d6473958f470333f111202064ce_executor), struct_ptr, __struct_compiled_op_b9146d6473958f470333f111202064ce_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb9146d6473958f470333f111202064ce(void){
   import_array();
   (void) Py_InitModule("b9146d6473958f470333f111202064ce", MyMethods);
}
