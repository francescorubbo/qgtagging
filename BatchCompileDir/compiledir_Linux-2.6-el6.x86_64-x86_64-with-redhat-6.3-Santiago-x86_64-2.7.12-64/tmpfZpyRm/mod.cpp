...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_612676a10c645272f28cf0d1e16916cb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_612676a10c645272f28cf0d1e16916cb() {
        ...
        ~__struct_compiled_op_612676a10c645272f28cf0d1e16916cb(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_13;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V11) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V1))){
...
V13_tmp1 = V11_i < -88.0f ? 0.0 : V11_i > 15.0f ? 1.0f : 1.0f /(1.0f + exp(-V11_i));
npy_float32 V13_tmp2;
V13_tmp2 = V3_i + V5_i;
npy_float32 V13_tmp3;
V13_tmp3 = V13_tmp2 < V7_i ? V7_i : V13_tmp2 > V9_i ? V9_i : V13_tmp2;
V1_i = V13_tmp3 * V13_tmp1;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_612676a10c645272f28cf0d1e16916cb_executor(__struct_compiled_op_612676a10c645272f28cf0d1e16916cb* self) {
            return self->run();
        }

        static void __struct_compiled_op_612676a10c645272f28cf0d1e16916cb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_612676a10c645272f28cf0d1e16916cb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_612676a10c645272f28cf0d1e16916cb* struct_ptr = new __struct_compiled_op_612676a10c645272f28cf0d1e16916cb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_612676a10c645272f28cf0d1e16916cb_executor), struct_ptr, __struct_compiled_op_612676a10c645272f28cf0d1e16916cb_destructor);
  return thunk; }
...
PyMODINIT_FUNC init612676a10c645272f28cf0d1e16916cb(void){
   import_array();
   (void) Py_InitModule("612676a10c645272f28cf0d1e16916cb", MyMethods);
}
