...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_16890a875bbf6be8de2772873491d598 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_16890a875bbf6be8de2772873491d598() {
        ...
        ~__struct_compiled_op_16890a875bbf6be8de2772873491d598(void) {
            cleanup();
        }
...
dims[2] = V3_n2;
        ...
        if (!V1) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(3, dims, NPY_INT8, 0);
            }
        }
        if (!V1) {
            {
        ...
        goto __label_7;}
                ...
                V1_stride2 = PyArray_STRIDES(V1)[2] / sizeof(npy_int8);
...
npy_int8 &V1_i = * ( V1_iter+V1_stride_l2*ITER_2+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_16890a875bbf6be8de2772873491d598_executor(__struct_compiled_op_16890a875bbf6be8de2772873491d598* self) {
            return self->run();
        }

        static void __struct_compiled_op_16890a875bbf6be8de2772873491d598_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_16890a875bbf6be8de2772873491d598*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_16890a875bbf6be8de2772873491d598* struct_ptr = new __struct_compiled_op_16890a875bbf6be8de2772873491d598();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_16890a875bbf6be8de2772873491d598_executor), struct_ptr, __struct_compiled_op_16890a875bbf6be8de2772873491d598_destructor);
  return thunk; }
...
PyMODINIT_FUNC init16890a875bbf6be8de2772873491d598(void){
   import_array();
   (void) Py_InitModule("16890a875bbf6be8de2772873491d598", MyMethods);
}
