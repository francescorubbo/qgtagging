...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_01a5718bd93af6489c7e21f087676b5f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_01a5718bd93af6489c7e21f087676b5f() {
        ...
        ~__struct_compiled_op_01a5718bd93af6489c7e21f087676b5f(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_01a5718bd93af6489c7e21f087676b5f_executor(__struct_compiled_op_01a5718bd93af6489c7e21f087676b5f* self) {
            return self->run();
        }

        static void __struct_compiled_op_01a5718bd93af6489c7e21f087676b5f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_01a5718bd93af6489c7e21f087676b5f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_01a5718bd93af6489c7e21f087676b5f* struct_ptr = new __struct_compiled_op_01a5718bd93af6489c7e21f087676b5f();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_01a5718bd93af6489c7e21f087676b5f_executor), struct_ptr, __struct_compiled_op_01a5718bd93af6489c7e21f087676b5f_destructor);
  return thunk; }
...
PyMODINIT_FUNC init01a5718bd93af6489c7e21f087676b5f(void){
   import_array();
   (void) Py_InitModule("01a5718bd93af6489c7e21f087676b5f", MyMethods);
}
