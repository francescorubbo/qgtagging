...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_301dfce26a0353c26367665bee1facf0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_301dfce26a0353c26367665bee1facf0() {
        ...
        ~__struct_compiled_op_301dfce26a0353c26367665bee1facf0(void) {
            cleanup();
        }
...
dims[1] = V5_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13));
        }
        else {
        ...
        goto __label_15;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V11) && PyArray_ISCONTIGUOUS(V13) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V1))){
...
V15_tmp2 = (V5_i >= V7_i);
npy_int8 V15_tmp3;
V15_tmp3 = (V15_tmp2 & V15_tmp1);
V1_i = V3_i * V15_tmp3 * V11_i * V13_i;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_301dfce26a0353c26367665bee1facf0_executor(__struct_compiled_op_301dfce26a0353c26367665bee1facf0* self) {
            return self->run();
        }

        static void __struct_compiled_op_301dfce26a0353c26367665bee1facf0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_301dfce26a0353c26367665bee1facf0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_301dfce26a0353c26367665bee1facf0* struct_ptr = new __struct_compiled_op_301dfce26a0353c26367665bee1facf0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_301dfce26a0353c26367665bee1facf0_executor), struct_ptr, __struct_compiled_op_301dfce26a0353c26367665bee1facf0_destructor);
  return thunk; }
...
PyMODINIT_FUNC init301dfce26a0353c26367665bee1facf0(void){
   import_array();
   (void) Py_InitModule("301dfce26a0353c26367665bee1facf0", MyMethods);
}
