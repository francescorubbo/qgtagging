...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_5558d5d588540c868bea4e3d250b251f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_5558d5d588540c868bea4e3d250b251f() {
        ...
        ~__struct_compiled_op_5558d5d588540c868bea4e3d250b251f(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_5558d5d588540c868bea4e3d250b251f_executor(__struct_compiled_op_5558d5d588540c868bea4e3d250b251f* self) {
            return self->run();
        }

        static void __struct_compiled_op_5558d5d588540c868bea4e3d250b251f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_5558d5d588540c868bea4e3d250b251f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_5558d5d588540c868bea4e3d250b251f* struct_ptr = new __struct_compiled_op_5558d5d588540c868bea4e3d250b251f();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_5558d5d588540c868bea4e3d250b251f_executor), struct_ptr, __struct_compiled_op_5558d5d588540c868bea4e3d250b251f_destructor);
  return thunk; }
...
PyMODINIT_FUNC init5558d5d588540c868bea4e3d250b251f(void){
   import_array();
   (void) Py_InitModule("5558d5d588540c868bea4e3d250b251f", MyMethods);
}
