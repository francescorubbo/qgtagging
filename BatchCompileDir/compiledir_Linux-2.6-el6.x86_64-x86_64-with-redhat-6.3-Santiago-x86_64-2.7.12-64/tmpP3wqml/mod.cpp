...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_51bea86f10901580cc75a61910de4479 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_51bea86f10901580cc75a61910de4479() {
        ...
        ~__struct_compiled_op_51bea86f10901580cc75a61910de4479(void) {
            cleanup();
        }
...
V17_0_tmp1 = ((V9_i)>(V7_i)? (V9_i): ((V7_i)>=(V9_i)? (V7_i): nan("")));
V17_tmp1 = V3_i ? V5_i : V17_0_tmp1;
}

npy_int64 V17_tmp2;
{
npy_int64 V17_1_tmp1;
V17_1_tmp1 = V17_tmp1 + V11_i;
npy_int8 V17_1_tmp2;
V17_1_tmp2 = (V17_tmp1 < V5_i);
...
{
npy_int8 V17_2_tmp1;
V17_2_tmp1 = (V17_tmp2 < V5_i);
V17_tmp3 = V17_2_tmp1 ? V13_i : V17_tmp2;
}

npy_int8 V17_tmp4;
V17_tmp4 = (V17_tmp3 >= V11_i);
V1_i = V17_tmp4 ? V15_i : V17_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_51bea86f10901580cc75a61910de4479_executor(__struct_compiled_op_51bea86f10901580cc75a61910de4479* self) {
            return self->run();
        }

        static void __struct_compiled_op_51bea86f10901580cc75a61910de4479_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_51bea86f10901580cc75a61910de4479*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_51bea86f10901580cc75a61910de4479* struct_ptr = new __struct_compiled_op_51bea86f10901580cc75a61910de4479();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_51bea86f10901580cc75a61910de4479_executor), struct_ptr, __struct_compiled_op_51bea86f10901580cc75a61910de4479_destructor);
  return thunk; }
...
PyMODINIT_FUNC init51bea86f10901580cc75a61910de4479(void){
   import_array();
   (void) Py_InitModule("51bea86f10901580cc75a61910de4479", MyMethods);
}
