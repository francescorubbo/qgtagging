...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c127a8a4396db50438c7142c2a1dee97 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c127a8a4396db50438c7142c2a1dee97() {
        ...
        ~__struct_compiled_op_c127a8a4396db50438c7142c2a1dee97(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c127a8a4396db50438c7142c2a1dee97_executor(__struct_compiled_op_c127a8a4396db50438c7142c2a1dee97* self) {
            return self->run();
        }

        static void __struct_compiled_op_c127a8a4396db50438c7142c2a1dee97_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c127a8a4396db50438c7142c2a1dee97*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c127a8a4396db50438c7142c2a1dee97* struct_ptr = new __struct_compiled_op_c127a8a4396db50438c7142c2a1dee97();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c127a8a4396db50438c7142c2a1dee97_executor), struct_ptr, __struct_compiled_op_c127a8a4396db50438c7142c2a1dee97_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc127a8a4396db50438c7142c2a1dee97(void){
   import_array();
   (void) Py_InitModule("c127a8a4396db50438c7142c2a1dee97", MyMethods);
}
