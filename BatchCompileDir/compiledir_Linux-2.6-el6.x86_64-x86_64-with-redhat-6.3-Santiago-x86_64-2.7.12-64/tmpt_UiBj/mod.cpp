...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a() {
        ...
        ~__struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_9;}
            ...
            if((PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V1))){
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a_executor(__struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a* self) {
            return self->run();
        }

        static void __struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a* struct_ptr = new __struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a_executor), struct_ptr, __struct_compiled_op_5a9fc7a360edbe3a2fca5e9fc0eb8a7a_destructor);
  return thunk; }
...
PyMODINIT_FUNC init5a9fc7a360edbe3a2fca5e9fc0eb8a7a(void){
   import_array();
   (void) Py_InitModule("5a9fc7a360edbe3a2fca5e9fc0eb8a7a", MyMethods);
}
