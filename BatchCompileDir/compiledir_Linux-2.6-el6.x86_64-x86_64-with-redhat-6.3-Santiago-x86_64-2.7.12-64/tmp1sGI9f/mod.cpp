...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89() {
        ...
        ~__struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_21;}
                ...
                V17_n1 = PyArray_DIMS(V17)[1];
                V17_stride1 = PyArray_STRIDES(V17)[1] / sizeof(npy_float32);
                V17_jump1_1 = (V17_stride1) - (0);
                //printf("V17_jump1_1 is:");
                //std::cout << V17_jump1_1 << std::endl;
                
                V17_n0 = PyArray_DIMS(V17)[0];
                V17_stride0 = PyArray_STRIDES(V17)[0] / sizeof(npy_float32);
                V17_jump0_0 = (V17_stride0) - (V17_n1*V17_stride1);
...
0, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V13_stride_l1 = init_strides[5][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V13_stride_l0 = init_strides[5][V5_loops_rit->second];
            ++V5_loops_rit;
            
        V5_loops_rit = V5_loops.rbegin();
            int V15_stride_l1 = init_strides[6][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V15_stride_l0 = init_strides[6][V5_loops_rit->second];
            ++V5_loops_rit;
            
        V5_loops_rit = V5_loops.rbegin();
            int V17_stride_l1 = init_strides[7][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V17_stride_l0 = init_strides[7][V5_loops_rit->second];
            ++V5_loops_rit;
            
        V5_loops_rit = V5_loops.rbegin();
            int V19_stride_l1 = init_strides[8][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V19_stride_l0 = init_strides[8][V5_loops_rit->second];
            ++V5_loops_rit;
...
npy_int8 &V11_i = * ( V11_iter+V11_stride_l1*ITER_1+V11_stride_l0*ITER_0);
npy_int8 &V13_i = * ( V13_iter+V13_stride_l1*ITER_1+V13_stride_l0*ITER_0);
npy_int8 &V15_i = * ( V15_iter+V15_stride_l1*ITER_1+V15_stride_l0*ITER_0);
...
npy_float32 &V19_i = * ( V19_iter+V19_stride_l1*ITER_1+V19_stride_l0*ITER_0);
            ...
            
        {
            #define V1_i V5_i
            {
npy_float32 V21_tmp1;
V21_tmp1 = V15_i ? V17_i : V19_i;
npy_float32 V21_tmp2;
V21_tmp2 = V9_i < V11_i ? V11_i : V9_i > V13_i ? V13_i : V9_i;
npy_float32 V21_tmp3;
V21_tmp3 = V3_i - V5_i;
npy_float32 V21_tmp4;
V21_tmp4 = V21_tmp3 * V5_i * V7_i * V21_tmp2;
V1_i = V21_tmp4 + V21_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89_executor(__struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89* self) {
            return self->run();
        }

        static void __struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89* struct_ptr = new __struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89_executor), struct_ptr, __struct_compiled_op_3a04f24f8c9fd3de2e93f91a14da3c89_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3a04f24f8c9fd3de2e93f91a14da3c89(void){
   import_array();
   (void) Py_InitModule("3a04f24f8c9fd3de2e93f91a14da3c89", MyMethods);
}
