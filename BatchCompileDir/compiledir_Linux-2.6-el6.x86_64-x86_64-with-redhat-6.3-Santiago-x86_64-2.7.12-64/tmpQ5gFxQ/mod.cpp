...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0() {
        ...
        ~__struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0(void) {
            cleanup();
        }
    ...
    {Py_XINCREF(py_V3);}
        ...
        goto __label_4;}
            ...
            if (!PyArray_ISALIGNED((PyArrayObject*) py_V3)) {
                ...
                PyErr_Format(PyExc_NotImplementedError,
                             "expected an aligned array of type %ld "
                             "(NPY_UINT8), got non-aligned array of type %ld"
                             " with %ld dimensions, with 3 last dims "
                             "%ld, %ld, %ld"
                             " and 3 last strides %ld %ld, %ld.",
                             (long int) NPY_UINT8,
        ...
        goto __label_4;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V3) != NPY_UINT8) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_UINT8) got %d",
                             NPY_UINT8, PyArray_TYPE((PyArrayObject*) py_V3));
                {
        __failure = 4;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
// Op class Elemwise
        ...
        goto __label_15;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V13) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V1))){
...
V15_tmp1 = V3_i ? V11_i : V13_i;
npy_float32 V15_tmp2;
V15_tmp2 = V5_i * V7_i;
npy_float32 V15_tmp3;
V15_tmp3 = V3_i ? V15_tmp2 : V9_i;
V1_i = V15_tmp3 + V15_tmp1;
}
;
                    }
...
V3_iter = (npy_uint8*)(PyArray_DATA(V3));
...
V13_iter = (npy_float32*)(PyArray_DATA(V13));
        ...
        { // begin loop 1
            npy_uint8 &V3_i = * ( V3_iter+V3_stride_l1*ITER_1+V3_stride_l0*ITER_0);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0_executor(__struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0* self) {
            return self->run();
        }

        static void __struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0* struct_ptr = new __struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0_executor), struct_ptr, __struct_compiled_op_b8d88c62564a63a21487df3ba9101ac0_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb8d88c62564a63a21487df3ba9101ac0(void){
   import_array();
   (void) Py_InitModule("b8d88c62564a63a21487df3ba9101ac0", MyMethods);
}
