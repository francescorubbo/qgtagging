...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca() {
        ...
        ~__struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca(void) {
            cleanup();
        }
...
V15_tmp1 = V7_i + V9_i;
npy_int64 V15_tmp2;
V15_tmp2 = ((V11_i)<(V15_tmp1)? (V11_i): ((V15_tmp1)<=(V11_i)? (V15_tmp1): nan("")));
npy_int64 V15_tmp3;
V15_tmp3 = ((V13_i)>(V15_tmp2)? (V13_i): ((V15_tmp2)>=(V13_i)? (V15_tmp2): nan("")));
V1_i = V3_i ? V5_i : V15_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca_executor(__struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca* self) {
            return self->run();
        }

        static void __struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca* struct_ptr = new __struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca_executor), struct_ptr, __struct_compiled_op_8aaef6622fe71a91be8345d0732ce7ca_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8aaef6622fe71a91be8345d0732ce7ca(void){
   import_array();
   (void) Py_InitModule("8aaef6622fe71a91be8345d0732ce7ca", MyMethods);
}
