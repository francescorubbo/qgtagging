...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_fe56a7eb607e3d4664f092365d662713 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_fe56a7eb607e3d4664f092365d662713() {
        ...
        ~__struct_compiled_op_fe56a7eb607e3d4664f092365d662713(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_fe56a7eb607e3d4664f092365d662713_executor(__struct_compiled_op_fe56a7eb607e3d4664f092365d662713* self) {
            return self->run();
        }

        static void __struct_compiled_op_fe56a7eb607e3d4664f092365d662713_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_fe56a7eb607e3d4664f092365d662713*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_fe56a7eb607e3d4664f092365d662713* struct_ptr = new __struct_compiled_op_fe56a7eb607e3d4664f092365d662713();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_fe56a7eb607e3d4664f092365d662713_executor), struct_ptr, __struct_compiled_op_fe56a7eb607e3d4664f092365d662713_destructor);
  return thunk; }
...
PyMODINIT_FUNC initfe56a7eb607e3d4664f092365d662713(void){
   import_array();
   (void) Py_InitModule("fe56a7eb607e3d4664f092365d662713", MyMethods);
}
