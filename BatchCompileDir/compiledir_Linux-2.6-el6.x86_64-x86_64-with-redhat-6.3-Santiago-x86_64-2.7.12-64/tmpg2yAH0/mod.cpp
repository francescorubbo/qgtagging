...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_91d58bbd2f427730a8f8f741f0791873 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_91d58bbd2f427730a8f8f741f0791873() {
        ...
        ~__struct_compiled_op_91d58bbd2f427730a8f8f741f0791873(void) {
            cleanup();
        }
...
// Op class Any
        ...
        goto __label_5;}
                ...
                V3_stride2 = PyArray_STRIDES(V3)[2] / sizeof(npy_int8);
                V3_jump2_2 = (V3_stride2) - (0);
                //printf("V3_jump2_2 is:");
                //std::cout << V3_jump2_2 << std::endl;
                
                V3_n1 = PyArray_DIMS(V3)[1];
                V3_stride1 = PyArray_STRIDES(V3)[1] / sizeof(npy_int8);
...
dims[1] = V3_n1;
        ...
        if (!V1) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(2, dims, NPY_INT8, 0);
            }
        }
        if (!V1) {
            {
        ...
        goto __label_5;}
                ...
                V1_stride1 = PyArray_STRIDES(V1)[1] / sizeof(npy_int8);
                V1_jump1_1 = (V1_stride1) - (0);
                //printf("V1_jump1_1 is:");
                //std::cout << V1_jump1_1 << std::endl;
                
                V1_n0 = PyArray_DIMS(V1)[0];
                V1_stride0 = PyArray_STRIDES(V1)[0] / sizeof(npy_int8);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_91d58bbd2f427730a8f8f741f0791873_executor(__struct_compiled_op_91d58bbd2f427730a8f8f741f0791873* self) {
            return self->run();
        }

        static void __struct_compiled_op_91d58bbd2f427730a8f8f741f0791873_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_91d58bbd2f427730a8f8f741f0791873*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_91d58bbd2f427730a8f8f741f0791873* struct_ptr = new __struct_compiled_op_91d58bbd2f427730a8f8f741f0791873();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_91d58bbd2f427730a8f8f741f0791873_executor), struct_ptr, __struct_compiled_op_91d58bbd2f427730a8f8f741f0791873_destructor);
  return thunk; }
...
PyMODINIT_FUNC init91d58bbd2f427730a8f8f741f0791873(void){
   import_array();
   (void) Py_InitModule("91d58bbd2f427730a8f8f741f0791873", MyMethods);
}
