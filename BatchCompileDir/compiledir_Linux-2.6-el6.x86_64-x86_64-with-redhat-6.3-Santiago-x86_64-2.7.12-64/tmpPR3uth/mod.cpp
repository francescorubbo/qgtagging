...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_fc3764857089c08626a6bf903e0a833c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_fc3764857089c08626a6bf903e0a833c() {
        ...
        ~__struct_compiled_op_fc3764857089c08626a6bf903e0a833c(void) {
            cleanup();
        }
...
V23_0_tmp1 = V7_i + V11_i + V13_i;
npy_int8 V23_0_tmp2;
V23_0_tmp2 = (V7_i < V9_i);
V23_tmp1 = V23_0_tmp2 ? V23_0_tmp1 : V7_i;
}

npy_int64 V23_tmp2;
{
npy_int8 V23_1_tmp1;
V23_1_tmp1 = (V23_tmp1 < V9_i);
V23_tmp2 = V23_1_tmp1 ? V15_i : V23_tmp1;
}

npy_int64 V23_tmp3;
{
npy_int8 V23_2_tmp1;
V23_2_tmp1 = (V23_tmp2 >= V17_i);
npy_int64 V23_2_tmp2;
V23_2_tmp2 = V23_2_tmp1 ? V17_i : V23_tmp2;
npy_int64 V23_2_tmp3;
V23_2_tmp3 = V5_i - V23_2_tmp2;
npy_int64 V23_2_tmp4;
V23_2_tmp4 = V23_2_tmp3 - V19_i;
npy_int64 V23_2_tmp5;

if (V23_2_tmp4 < 0) {
    if (V11_i < 0) {
        V23_2_tmp5 = ((-V23_2_tmp4) / (-V11_i));
    } else {
        V23_2_tmp5 = - ((-V23_2_tmp4) / V11_i) - ((THEANO_MACRO_MOD((-V23_2_tmp4), V11_i) == 0) ? 0 : 1);
    }
} else {
    if (V11_i < 0) {
        V23_2_tmp5 = - (V23_2_tmp4 / (-V11_i)) - ((THEANO_MACRO_MOD(V23_2_tmp4, (-V11_i)) == 0) ? 0 : 1);
...
V23_tmp3 = V23_2_tmp5 + V19_i;
}

npy_int64 V23_tmp4;
{
npy_int8 V23_3_tmp1;
V23_3_tmp1 = (V23_tmp3 < V9_i);
npy_int64 V23_3_tmp2;
V23_3_tmp2 = V23_3_tmp1 ? V9_i : V23_tmp3;
npy_int64 V23_3_tmp3;
V23_3_tmp3 = V23_3_tmp2 - V19_i;
npy_int64 V23_3_tmp4;
V23_3_tmp4 = V3_i - V23_3_tmp3;
V23_tmp4 = V23_3_tmp4 - V19_i;
}

npy_int64 V23_tmp5;
{
npy_int64 V23_4_tmp1;
V23_4_tmp1 = V3_i - V19_i;
npy_int8 V23_4_tmp2;
V23_4_tmp2 = (V23_tmp4 < V9_i);
V23_tmp5 = V23_4_tmp2 ? V23_4_tmp1 : V23_tmp4;
}

npy_int64 V23_tmp6;
{
npy_int8 V23_5_tmp1;
V23_5_tmp1 = (V23_tmp5 < V9_i);
V23_tmp6 = V23_5_tmp1 ? V9_i : V23_tmp5;
}

npy_int8 V23_tmp7;
V23_tmp7 = (V23_tmp6 < V21_i);
npy_int64 V23_tmp8;
V23_tmp8 = V23_tmp7 ? V23_tmp6 : V21_i;
npy_int64 V23_tmp9;
V23_tmp9 = V23_tmp8 - V13_i;
V1_i = V23_tmp9 - V19_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_fc3764857089c08626a6bf903e0a833c_executor(__struct_compiled_op_fc3764857089c08626a6bf903e0a833c* self) {
            return self->run();
        }

        static void __struct_compiled_op_fc3764857089c08626a6bf903e0a833c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_fc3764857089c08626a6bf903e0a833c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_fc3764857089c08626a6bf903e0a833c* struct_ptr = new __struct_compiled_op_fc3764857089c08626a6bf903e0a833c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_fc3764857089c08626a6bf903e0a833c_executor), struct_ptr, __struct_compiled_op_fc3764857089c08626a6bf903e0a833c_destructor);
  return thunk; }
...
PyMODINIT_FUNC initfc3764857089c08626a6bf903e0a833c(void){
   import_array();
   (void) Py_InitModule("fc3764857089c08626a6bf903e0a833c", MyMethods);
}
