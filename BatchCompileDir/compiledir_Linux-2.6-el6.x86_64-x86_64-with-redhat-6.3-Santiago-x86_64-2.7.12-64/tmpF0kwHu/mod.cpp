...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be() {
        ...
        ~__struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be(void) {
            cleanup();
        }
                ...
                
    {
        ...
        if (!acc) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(acc);
                acc = (PyArrayObject*)PyArray_EMPTY(0, dims, NPY_INT64, 0);
            }
        }
        if (!acc) {
            {
...
acc_iter = (npy_int64*)(PyArray_DATA(acc));
npy_int64& acc_i = *acc_iter;
acc_i = 0;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be_executor(__struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be* self) {
            return self->run();
        }

        static void __struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be* struct_ptr = new __struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be_executor), struct_ptr, __struct_compiled_op_dd842d1ef2cbbb27394576bae95e69be_destructor);
  return thunk; }
...
PyMODINIT_FUNC initdd842d1ef2cbbb27394576bae95e69be(void){
   import_array();
   (void) Py_InitModule("dd842d1ef2cbbb27394576bae95e69be", MyMethods);
}
