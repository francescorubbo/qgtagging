...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ab095cc454dbd2170184011f294df0dd {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ab095cc454dbd2170184011f294df0dd() {
        ...
        ~__struct_compiled_op_ab095cc454dbd2170184011f294df0dd(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ab095cc454dbd2170184011f294df0dd_executor(__struct_compiled_op_ab095cc454dbd2170184011f294df0dd* self) {
            return self->run();
        }

        static void __struct_compiled_op_ab095cc454dbd2170184011f294df0dd_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_ab095cc454dbd2170184011f294df0dd*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ab095cc454dbd2170184011f294df0dd* struct_ptr = new __struct_compiled_op_ab095cc454dbd2170184011f294df0dd();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_ab095cc454dbd2170184011f294df0dd_executor), struct_ptr, __struct_compiled_op_ab095cc454dbd2170184011f294df0dd_destructor);
  return thunk; }
...
PyMODINIT_FUNC initab095cc454dbd2170184011f294df0dd(void){
   import_array();
   (void) Py_InitModule("ab095cc454dbd2170184011f294df0dd", MyMethods);
}
