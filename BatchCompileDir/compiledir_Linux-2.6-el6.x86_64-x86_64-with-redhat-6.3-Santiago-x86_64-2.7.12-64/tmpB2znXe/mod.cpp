...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_9f4958e6b79b842d88388387232831cb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_9f4958e6b79b842d88388387232831cb() {
        ...
        ~__struct_compiled_op_9f4958e6b79b842d88388387232831cb(void) {
            cleanup();
        }
...
dims[1] = V3_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9));
        }
        else {
        ...
        goto __label_11;}
            ...
            if((PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V1))){
...
V1_i = V11_tmp3 < -88.0f ? 0.0 : V11_tmp3 > 15.0f ? 1.0f : 1.0f /(1.0f + exp(-V11_tmp3));
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_9f4958e6b79b842d88388387232831cb_executor(__struct_compiled_op_9f4958e6b79b842d88388387232831cb* self) {
            return self->run();
        }

        static void __struct_compiled_op_9f4958e6b79b842d88388387232831cb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_9f4958e6b79b842d88388387232831cb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_9f4958e6b79b842d88388387232831cb* struct_ptr = new __struct_compiled_op_9f4958e6b79b842d88388387232831cb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_9f4958e6b79b842d88388387232831cb_executor), struct_ptr, __struct_compiled_op_9f4958e6b79b842d88388387232831cb_destructor);
  return thunk; }
...
PyMODINIT_FUNC init9f4958e6b79b842d88388387232831cb(void){
   import_array();
   (void) Py_InitModule("9f4958e6b79b842d88388387232831cb", MyMethods);
}
