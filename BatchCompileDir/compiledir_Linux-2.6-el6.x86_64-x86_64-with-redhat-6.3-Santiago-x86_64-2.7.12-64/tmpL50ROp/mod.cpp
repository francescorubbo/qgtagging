...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_621c29483717d09232856febdbbd9715 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_621c29483717d09232856febdbbd9715() {
        ...
        ~__struct_compiled_op_621c29483717d09232856febdbbd9715(void) {
            cleanup();
        }
...
// Op class CGemv
    ...
    if (!1)
    {
        ...
        goto __label_13;};
            if (PyArray_FillWithScalar(V1, zero) != 0) {
        __failure = 13;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
                "Unexpected error in an Op's C code. "
    ...
    }
    {
         ...
         *  - are not 0.
         */
        int SA0 = (NA0 > 1) ? (PyArray_STRIDES(V7)[0] / elemsize) : (NA1 + 1);
        int SA1 = (NA1 > 1) ? (PyArray_STRIDES(V7)[1] / elemsize) : (NA0 + 1);
        int Sz = PyArray_STRIDES(V1)[0] / elemsize;
        int Sx = PyArray_STRIDES(V9)[0] / elemsize;

        dtype_V9* x_data = (dtype_V9*) PyArray_DATA(V9);
        ...
        goto __label_13;}
                Py_XDECREF(V7);
                V7 = A_copy;
                SA0 = (NA0 > 1) ? (PyArray_STRIDES(V7)[0] / elemsize) : (NA1 + 1);
                SA1 = (NA1 > 1) ? (PyArray_STRIDES(V7)[1] / elemsize) : (NA0 + 1);
            }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_621c29483717d09232856febdbbd9715_executor(__struct_compiled_op_621c29483717d09232856febdbbd9715* self) {
            return self->run();
        }

        static void __struct_compiled_op_621c29483717d09232856febdbbd9715_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_621c29483717d09232856febdbbd9715*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_621c29483717d09232856febdbbd9715* struct_ptr = new __struct_compiled_op_621c29483717d09232856febdbbd9715();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_621c29483717d09232856febdbbd9715_executor), struct_ptr, __struct_compiled_op_621c29483717d09232856febdbbd9715_destructor);
  return thunk; }
...
PyMODINIT_FUNC init621c29483717d09232856febdbbd9715(void){
   import_array();
   (void) Py_InitModule("621c29483717d09232856febdbbd9715", MyMethods);
}
