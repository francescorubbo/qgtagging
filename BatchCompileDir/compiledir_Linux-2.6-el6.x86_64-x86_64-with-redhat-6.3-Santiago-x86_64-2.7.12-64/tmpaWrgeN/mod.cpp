...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f77ec76764814abf6a568ec81999c4d2 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f77ec76764814abf6a568ec81999c4d2() {
        ...
        ~__struct_compiled_op_f77ec76764814abf6a568ec81999c4d2(void) {
            cleanup();
        }
...
V19_0_tmp1 = V7_i + V9_i + V11_i + V13_i;
npy_int8 V19_0_tmp2;
V19_0_tmp2 = (V3_i < V5_i);
V19_tmp1 = V19_0_tmp2 ? V19_0_tmp1 : V3_i;
}

npy_int64 V19_tmp2;
{
npy_int8 V19_1_tmp1;
V19_1_tmp1 = (V19_tmp1 < V5_i);
V19_tmp2 = V19_1_tmp1 ? V5_i : V19_tmp1;
}
...
V19_tmp3 = V19_2_tmp1 ? V15_i : V19_tmp2;
}
...
V19_tmp4 = V19_3_tmp1 ? V5_i : V19_tmp3;
}

npy_int8 V19_tmp5;
V19_tmp5 = (V19_tmp4 < V17_i);
V1_i = V19_tmp5 ? V19_tmp4 : V17_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f77ec76764814abf6a568ec81999c4d2_executor(__struct_compiled_op_f77ec76764814abf6a568ec81999c4d2* self) {
            return self->run();
        }

        static void __struct_compiled_op_f77ec76764814abf6a568ec81999c4d2_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f77ec76764814abf6a568ec81999c4d2*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f77ec76764814abf6a568ec81999c4d2* struct_ptr = new __struct_compiled_op_f77ec76764814abf6a568ec81999c4d2();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f77ec76764814abf6a568ec81999c4d2_executor), struct_ptr, __struct_compiled_op_f77ec76764814abf6a568ec81999c4d2_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf77ec76764814abf6a568ec81999c4d2(void){
   import_array();
   (void) Py_InitModule("f77ec76764814abf6a568ec81999c4d2", MyMethods);
}
