...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_337d30a28301f8786285cb5092681843 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_337d30a28301f8786285cb5092681843() {
        ...
        ~__struct_compiled_op_337d30a28301f8786285cb5092681843(void) {
            cleanup();
        }
...
dims[1] = V5_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9));
        }
        else {
        ...
        goto __label_11;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V1))){
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_337d30a28301f8786285cb5092681843_executor(__struct_compiled_op_337d30a28301f8786285cb5092681843* self) {
            return self->run();
        }

        static void __struct_compiled_op_337d30a28301f8786285cb5092681843_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_337d30a28301f8786285cb5092681843*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_337d30a28301f8786285cb5092681843* struct_ptr = new __struct_compiled_op_337d30a28301f8786285cb5092681843();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_337d30a28301f8786285cb5092681843_executor), struct_ptr, __struct_compiled_op_337d30a28301f8786285cb5092681843_destructor);
  return thunk; }
...
PyMODINIT_FUNC init337d30a28301f8786285cb5092681843(void){
   import_array();
   (void) Py_InitModule("337d30a28301f8786285cb5092681843", MyMethods);
}
