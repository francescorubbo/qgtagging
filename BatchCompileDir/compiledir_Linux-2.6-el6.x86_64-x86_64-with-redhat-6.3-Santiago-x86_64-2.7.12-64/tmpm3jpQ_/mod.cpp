...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1() {
        ...
        ~__struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1(void) {
            cleanup();
        }
        ...
        
{
    ...
    {Py_XINCREF(py_V17);}
        ...
        goto __label_18;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V17) != NPY_INT8) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_INT8) got %d",
                             NPY_INT8, PyArray_TYPE((PyArrayObject*) py_V17));
                {
        __failure = 18;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
// Op class Elemwise
        ...
        goto __label_21;}
                ...
                V3_stride0 = PyArray_STRIDES(V3)[0] / sizeof(npy_int8);
...
0, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V11_loops_rit;
        ...
        V11_loops_rit = V11_loops.rbegin();
            int V19_stride_l1 = init_strides[8][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V19_stride_l0 = init_strides[8][V11_loops_rit->second];
            ++V11_loops_rit;
...
V17_iter = (npy_int8*)(PyArray_DATA(V17));
...
npy_int8 &V17_i = * ( V17_iter+V17_stride_l1*ITER_1+V17_stride_l0*ITER_0);
npy_int8 &V19_i = * ( V19_iter+V19_stride_l1*ITER_1+V19_stride_l0*ITER_0);
...
V21_tmp1 = V15_i < V17_i ? V17_i : V15_i > V19_i ? V19_i : V15_i;
npy_float32 V21_tmp2;
V21_tmp2 = V9_i - V11_i;
npy_float32 V21_tmp3;
V21_tmp3 = V3_i ? V5_i : V7_i;
npy_float32 V21_tmp4;
V21_tmp4 = V21_tmp2 * V11_i * V13_i * V21_tmp1;
V1_i = V21_tmp3 + V21_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1_executor(__struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1* self) {
            return self->run();
        }

        static void __struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1* struct_ptr = new __struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1_executor), struct_ptr, __struct_compiled_op_bf2936f0bdc2f2cd124249ceb894dea1_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbf2936f0bdc2f2cd124249ceb894dea1(void){
   import_array();
   (void) Py_InitModule("bf2936f0bdc2f2cd124249ceb894dea1", MyMethods);
}
