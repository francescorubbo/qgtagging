...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_d848d96800e99d0928e0cce74374b93d {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d848d96800e99d0928e0cce74374b93d() {
        ...
        ~__struct_compiled_op_d848d96800e99d0928e0cce74374b93d(void) {
            cleanup();
        }
...
V19_1_tmp1 = V7_i + V9_i;
npy_int64 V19_1_tmp2;
V19_1_tmp2 = ((V11_i)<(V19_1_tmp1)? (V11_i): ((V19_1_tmp1)<=(V11_i)? (V19_1_tmp1): nan("")));
npy_int64 V19_1_tmp3;
V19_1_tmp3 = ((V13_i)>(V19_1_tmp2)? (V13_i): ((V19_1_tmp2)>=(V13_i)? (V19_1_tmp2): nan("")));
V19_tmp2 = V3_i ? V5_i : V19_1_tmp3;
}

npy_int64 V19_tmp3;
{
npy_int64 V19_2_tmp1;
V19_2_tmp1 = V19_tmp2 + V15_i;
npy_int8 V19_2_tmp2;
V19_2_tmp2 = (V19_tmp2 < V5_i);
V19_tmp3 = V19_2_tmp2 ? V19_2_tmp1 : V19_tmp2;
}

npy_int64 V19_tmp4;
{
npy_int8 V19_3_tmp1;
V19_3_tmp1 = (V19_tmp3 < V5_i);
V19_tmp4 = V19_3_tmp1 ? V17_i : V19_tmp3;
}

npy_int8 V19_tmp5;
V19_tmp5 = (V19_tmp4 >= V15_i);
V1_i = V19_tmp5 ? V19_tmp1 : V19_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d848d96800e99d0928e0cce74374b93d_executor(__struct_compiled_op_d848d96800e99d0928e0cce74374b93d* self) {
            return self->run();
        }

        static void __struct_compiled_op_d848d96800e99d0928e0cce74374b93d_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d848d96800e99d0928e0cce74374b93d*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d848d96800e99d0928e0cce74374b93d* struct_ptr = new __struct_compiled_op_d848d96800e99d0928e0cce74374b93d();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d848d96800e99d0928e0cce74374b93d_executor), struct_ptr, __struct_compiled_op_d848d96800e99d0928e0cce74374b93d_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd848d96800e99d0928e0cce74374b93d(void){
   import_array();
   (void) Py_InitModule("d848d96800e99d0928e0cce74374b93d", MyMethods);
}
