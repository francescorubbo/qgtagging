...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024() {
        ...
        ~__struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024(void) {
            cleanup();
        }
...
V11_tmp1 = (npy_float32)V9_i;
npy_float32 V11_tmp2;
V11_tmp2 = (npy_float32)V7_i;
npy_float32 V11_tmp3;
V11_tmp3 = V5_i / V11_tmp2;
npy_float32 V11_tmp4;
V11_tmp4 = V3_i / V11_tmp3;
V1_i = V11_tmp4 / V11_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024_executor(__struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024* self) {
            return self->run();
        }

        static void __struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024* struct_ptr = new __struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024_executor), struct_ptr, __struct_compiled_op_d4a3bd260e0d94438e7a5844221c0024_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd4a3bd260e0d94438e7a5844221c0024(void){
   import_array();
   (void) Py_InitModule("d4a3bd260e0d94438e7a5844221c0024", MyMethods);
}
