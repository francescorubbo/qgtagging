...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8343e498822eacef77a06a24d36682b4 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8343e498822eacef77a06a24d36682b4() {
        ...
        ~__struct_compiled_op_8343e498822eacef77a06a24d36682b4(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8343e498822eacef77a06a24d36682b4_executor(__struct_compiled_op_8343e498822eacef77a06a24d36682b4* self) {
            return self->run();
        }

        static void __struct_compiled_op_8343e498822eacef77a06a24d36682b4_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8343e498822eacef77a06a24d36682b4*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8343e498822eacef77a06a24d36682b4* struct_ptr = new __struct_compiled_op_8343e498822eacef77a06a24d36682b4();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8343e498822eacef77a06a24d36682b4_executor), struct_ptr, __struct_compiled_op_8343e498822eacef77a06a24d36682b4_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8343e498822eacef77a06a24d36682b4(void){
   import_array();
   (void) Py_InitModule("8343e498822eacef77a06a24d36682b4", MyMethods);
}
