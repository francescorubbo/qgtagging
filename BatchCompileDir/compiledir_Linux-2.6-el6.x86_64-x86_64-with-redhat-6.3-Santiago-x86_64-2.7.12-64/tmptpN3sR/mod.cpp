...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f() {
        ...
        ~__struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f_executor(__struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f* self) {
            return self->run();
        }

        static void __struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f* struct_ptr = new __struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f_executor), struct_ptr, __struct_compiled_op_6a0ec665ac21b23930a0a48a02d3a69f_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6a0ec665ac21b23930a0a48a02d3a69f(void){
   import_array();
   (void) Py_InitModule("6a0ec665ac21b23930a0a48a02d3a69f", MyMethods);
}
