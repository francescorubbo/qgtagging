...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237() {
        ...
        ~__struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_17;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V11) && PyArray_ISCONTIGUOUS(V13) && PyArray_ISCONTIGUOUS(V15) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V15) && PyArray_ISFORTRAN(V1))){
...
V17_tmp1 = V15_i < -88.0f ? 0.0 : V15_i > 15.0f ? 1.0f : 1.0f /(1.0f + exp(-V15_i));
npy_float32 V17_tmp2;
V17_tmp2 = V3_i + V13_i;
npy_float32 V17_tmp3;
V17_tmp3 = V3_i + V5_i;
npy_float32 V17_tmp4;
V17_tmp4 = V17_tmp2 < V7_i ? V7_i : V17_tmp2 > V9_i ? V9_i : V17_tmp2;
npy_float32 V17_tmp5;
V17_tmp5 = V17_tmp3 < V7_i ? V7_i : V17_tmp3 > V9_i ? V9_i : V17_tmp3;
npy_float32 V17_tmp6;
V17_tmp6 = V17_tmp4 * V17_tmp1;
npy_float32 V17_tmp7;
V17_tmp7 = V17_tmp5 * V11_i;
V1_i = V17_tmp7 + V17_tmp6;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237_executor(__struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237* self) {
            return self->run();
        }

        static void __struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237* struct_ptr = new __struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237_executor), struct_ptr, __struct_compiled_op_2ee04f044a66ef6e967f542d9c8f4237_destructor);
  return thunk; }
...
PyMODINIT_FUNC init2ee04f044a66ef6e967f542d9c8f4237(void){
   import_array();
   (void) Py_InitModule("2ee04f044a66ef6e967f542d9c8f4237", MyMethods);
}
