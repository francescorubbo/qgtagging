...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_7905d89578c29ee25751a27268b03260 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7905d89578c29ee25751a27268b03260() {
        ...
        ~__struct_compiled_op_7905d89578c29ee25751a27268b03260(void) {
            cleanup();
        }
...
V15_0_tmp1 = V5_i - V7_i;
npy_int64 V15_0_tmp2;
V15_0_tmp2 = V15_0_tmp1 - V9_i;
npy_int64 V15_0_tmp3;

if (V15_0_tmp2 < 0) {
    if (V9_i < 0) {
        V15_0_tmp3 = ((-V15_0_tmp2) / (-V9_i));
    } else {
        V15_0_tmp3 = - ((-V15_0_tmp2) / V9_i) - ((THEANO_MACRO_MOD((-V15_0_tmp2), V9_i) == 0) ? 0 : 1);
    }
} else {
    if (V9_i < 0) {
        V15_0_tmp3 = - (V15_0_tmp2 / (-V9_i)) - ((THEANO_MACRO_MOD(V15_0_tmp2, (-V9_i)) == 0) ? 0 : 1);
...
V15_tmp1 = V15_0_tmp3 + V9_i;
}

npy_int64 V15_tmp2;
{
npy_int8 V15_1_tmp1;
V15_1_tmp1 = (V15_tmp1 < V11_i);
npy_int64 V15_1_tmp2;
V15_1_tmp2 = V15_1_tmp1 ? V11_i : V15_tmp1;
npy_int64 V15_1_tmp3;
V15_1_tmp3 = V15_1_tmp2 - V9_i;
npy_int64 V15_1_tmp4;
V15_1_tmp4 = V3_i - V15_1_tmp3;
V15_tmp2 = V15_1_tmp4 - V9_i;
}

npy_int64 V15_tmp3;
{
npy_int64 V15_2_tmp1;
V15_2_tmp1 = V3_i - V9_i;
npy_int8 V15_2_tmp2;
V15_2_tmp2 = (V15_tmp2 < V11_i);
V15_tmp3 = V15_2_tmp2 ? V15_2_tmp1 : V15_tmp2;
}

npy_int64 V15_tmp4;
{
npy_int8 V15_3_tmp1;
V15_3_tmp1 = (V15_tmp3 < V11_i);
V15_tmp4 = V15_3_tmp1 ? V11_i : V15_tmp3;
}

npy_int8 V15_tmp5;
V15_tmp5 = (V15_tmp4 < V13_i);
V1_i = V15_tmp5 ? V15_tmp4 : V13_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7905d89578c29ee25751a27268b03260_executor(__struct_compiled_op_7905d89578c29ee25751a27268b03260* self) {
            return self->run();
        }

        static void __struct_compiled_op_7905d89578c29ee25751a27268b03260_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7905d89578c29ee25751a27268b03260*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7905d89578c29ee25751a27268b03260* struct_ptr = new __struct_compiled_op_7905d89578c29ee25751a27268b03260();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7905d89578c29ee25751a27268b03260_executor), struct_ptr, __struct_compiled_op_7905d89578c29ee25751a27268b03260_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7905d89578c29ee25751a27268b03260(void){
   import_array();
   (void) Py_InitModule("7905d89578c29ee25751a27268b03260", MyMethods);
}
