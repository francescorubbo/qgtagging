...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a04de7addca5f2a49927a48c02572f61 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a04de7addca5f2a49927a48c02572f61() {
        ...
        ~__struct_compiled_op_a04de7addca5f2a49927a48c02572f61(void) {
            cleanup();
        }
...
V19_tmp2 = V19_1_tmp1 ? V15_i : V19_tmp1;
}

npy_int64 V19_tmp3;
{
npy_int8 V19_2_tmp1;
V19_2_tmp1 = (V19_tmp2 >= V17_i);
V19_tmp3 = V19_2_tmp1 ? V17_i : V19_tmp2;
}

npy_int8 V19_tmp4;
V19_tmp4 = (V19_tmp3 < V5_i);
V1_i = V19_tmp4 ? V5_i : V19_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a04de7addca5f2a49927a48c02572f61_executor(__struct_compiled_op_a04de7addca5f2a49927a48c02572f61* self) {
            return self->run();
        }

        static void __struct_compiled_op_a04de7addca5f2a49927a48c02572f61_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a04de7addca5f2a49927a48c02572f61*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a04de7addca5f2a49927a48c02572f61* struct_ptr = new __struct_compiled_op_a04de7addca5f2a49927a48c02572f61();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a04de7addca5f2a49927a48c02572f61_executor), struct_ptr, __struct_compiled_op_a04de7addca5f2a49927a48c02572f61_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita04de7addca5f2a49927a48c02572f61(void){
   import_array();
   (void) Py_InitModule("a04de7addca5f2a49927a48c02572f61", MyMethods);
}
