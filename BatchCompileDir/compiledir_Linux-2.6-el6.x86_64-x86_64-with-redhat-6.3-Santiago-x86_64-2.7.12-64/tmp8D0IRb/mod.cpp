...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9() {
        ...
        ~__struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9(void) {
            cleanup();
        }
...
npy_int8& V17_i = *V17_iter;
npy_int64& V19_i = *V19_iter;

                  {
npy_int64 V21_tmp1;
{
npy_int64 V21_0_tmp1;
V21_0_tmp1 = V7_i + V9_i;
npy_int64 V21_0_tmp2;
V21_0_tmp2 = ((V11_i)<(V21_0_tmp1)? (V11_i): ((V21_0_tmp1)<=(V11_i)? (V21_0_tmp1): nan("")));
npy_int64 V21_0_tmp3;
V21_0_tmp3 = ((V13_i)>(V21_0_tmp2)? (V13_i): ((V21_0_tmp2)>=(V13_i)? (V21_0_tmp2): nan("")));
V21_tmp1 = V3_i ? V5_i : V21_0_tmp3;
}

npy_int64 V21_tmp2;
{
npy_int64 V21_1_tmp1;
V21_1_tmp1 = V15_i + V21_tmp1;
npy_int8 V21_1_tmp2;
V21_1_tmp2 = (V21_tmp1 < V5_i);
V21_tmp2 = V21_1_tmp2 ? V21_1_tmp1 : V21_tmp1;
}

npy_int64 V21_tmp3;
{
npy_int8 V21_2_tmp1;
V21_2_tmp1 = (V21_tmp2 < V5_i);
V21_tmp3 = V21_2_tmp1 ? V17_i : V21_tmp2;
}

npy_int8 V21_tmp4;
V21_tmp4 = (V21_tmp3 >= V15_i);
V1_i = V21_tmp4 ? V19_i : V21_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9_executor(__struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9* self) {
            return self->run();
        }

        static void __struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9* struct_ptr = new __struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9_executor), struct_ptr, __struct_compiled_op_ccfe22dc55a1a1e95c03bb4cdc725bd9_destructor);
  return thunk; }
...
PyMODINIT_FUNC initccfe22dc55a1a1e95c03bb4cdc725bd9(void){
   import_array();
   (void) Py_InitModule("ccfe22dc55a1a1e95c03bb4cdc725bd9", MyMethods);
}
